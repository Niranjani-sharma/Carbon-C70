        ...
        <div className="login_container">
          <div className="login_div1">
            <div className="login_subdiv1">
              <span id="login_heading">Welcome, Coal Mine Owner</span>
              <br />
              <span className="login_subdiv1_para">
                Fill in the credentials Provided by Gov of India
              </span>
              <br />
              <br />
            </div>
            ...
            <div className="login_lastpara">
              <p id="login_lastpara">
                Company User?
                <a href="/CompanyLoginPage" id="login_lastpara_a">
                  Click Here to Go to Company Login Page
                </a>
              </p>
            </div>
